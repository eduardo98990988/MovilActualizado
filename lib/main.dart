  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/productos': (context) => const MyHomeProduc(),
        '/materiales': (context) => const WelcomePage(),
        '/empleado': (context) => const WelcomePage(),
        '/RegistroProveedor': (context) => const RegistroProveedor(),
      },
      title: 'Flutter Demo',
      theme: ThemeData(
